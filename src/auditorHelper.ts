...
export async function checkForEmptyFolders(folderPath: string, auditResults: AuditResults): Promise<void> {
    try {
...
export async function checkForEnvExWithoutEnv(folderPath: string, auditResults: AuditResults): Promise<void> {
    try {
...
export async function checkForMultipleLockFiles(folderPath: string, auditResults: AuditResults): Promise<void> {
    try {
...
export async function checkForDuplicatedTypeFiles(folderPath: string, fileType: FileTypes, auditResults: AuditResults): Promise<void> {
    try {
...
export async function checkForUnstagedFiles(dir: string, auditResults: AuditResults): Promise<void> {
  try {
